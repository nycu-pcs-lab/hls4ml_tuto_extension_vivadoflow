...
wire [47 : 0] input_1;
wire  input_1_ap_vld;
wire [5 : 0] layer3_out_0;
wire  layer3_out_0_ap_vld;
wire [5 : 0] layer3_out_1;
wire  layer3_out_1_ap_vld;
wire [5 : 0] layer3_out_2;
wire  layer3_out_2_ap_vld;
wire [5 : 0] layer3_out_3;
wire  layer3_out_3_ap_vld;
wire [5 : 0] layer3_out_4;
wire  layer3_out_4_ap_vld;
wire [5 : 0] layer3_out_5;
wire  layer3_out_5_ap_vld;
wire [5 : 0] layer3_out_6;
wire  layer3_out_6_ap_vld;
wire [5 : 0] layer3_out_7;
...
reg [5: 0] AESL_REG_layer3_out_0 = 0;
...
reg [5: 0] AESL_REG_layer3_out_1 = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
...
reg [5: 0] AESL_REG_layer3_out_2 = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
...
reg [5: 0] AESL_REG_layer3_out_3 = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
...
reg [5: 0] AESL_REG_layer3_out_4 = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
...
reg [5: 0] AESL_REG_layer3_out_5 = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
...
reg [5: 0] AESL_REG_layer3_out_6 = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
...
reg [5: 0] AESL_REG_layer3_out_7 = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
